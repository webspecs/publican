...
exports.transformRepositories = function (repos, conf, cb) {
    ...
    async.each(
        exports.canonical2pairs(repos)
    ,   function (target, cb) {
            exports.transformRepository(conf, target.publishDir, target.fileName, cb);
        }
    ,   cb
    );
};

exports.transformRepository = function (conf, publishDir, fileName, cb) {
    ...
    if (fs.existsSync(baseName + ".bs")) {
        ...
        rs.respec(publishDir, fileName, cb);
    }
    ...
    async.series(
        ...
        ,   function (cb) {
                if (regen === "all") {
                    ...
                    exports.transformRepository(conf, jn(dataDir, "publish", wanted[repo].branches[branch]), wanted[repo].fileName, cb);
                }
            }
