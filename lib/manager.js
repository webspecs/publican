...
exports.runAppropriateTask = function (repoDesc, cb) {
    var repo = repoDesc.repository;
    // load the task we need based on the repoDesc
    // prepare all the fields in the context that it needs
    // set it up with the cb
    // run it
