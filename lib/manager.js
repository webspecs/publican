...
exports.generateRepositories = function (repositories, conf, cb) {
    async.series(
        [
            function (cb) {
                log.info("Getting list of repositories");
                exports.getRepositories(repositories, conf, cb);
            }
        ,   function (cb) {
                log.info("Publishing list of repositories");
                exports.publishRepositories(repositories, conf, cb);
            }
        ,   function (cb) {
                log.info("Bikeshedding list of repositories");
                exports.bikeshedRepositories(repositories, conf, cb);
            }
        ]
    ,   cb
    );
...
exports.processRepository = function (data, cb) {
    ...
    async.series(
        ...
        ,   function (cb) { git.publish(jn(dataDir, "gits", repo), branch, jn(dataDir, "publish", wanted[repo].branches[branch]), cb); }
        ,   function (cb) {
                if (regen === "all") {
                    exports.generateRepositories(exports.commonRepositories(), conf, cb);
                }
